...
public class SubArrayWithGivenSum {
	...
	/*
	 * public static void findArray2(int[] arr, int sum) { int start = 0, end = 0,
	 * currSum = 0;
	 * 
	 * while (start < arr.length -1) {
	 * 
	 * if (currSum<sum) { currSum += arr[end]; end++; }
	 * 
	 * else if (currSum ==sum) { System.out.println("sum found between index : " +
	 * start + " and " + (end-1)); return ; }
	 * 
	 * else { currSum -= arr[start]; start++; } }
	 * System.out.println("No subarray found"); }
	 */
