...
public class CheckIfTreeIsBSTOrNot {
	...
	// Another approach  - 
	// we can do the inorder traversal of the binary tree and and store the result in an array
	...
	// Given two nodes data, this method finds the lowest common ancestor of two nodes.
