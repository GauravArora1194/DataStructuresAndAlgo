...
public class BinaryTree {
	...
	// prints the level order traversal of a binary tree using recursion.
	public static void levelOrderTraversalUsingRecursion(Node node) {

		int height = treeMaxHeight(node);
	...
	public static void levelOrderInSpiralForm(Node node) {
		...
		// create two stacks one for left to right traversal and one for right to left
		// traversal
	...
	public static void verticalOrderTraversal(Node node) {
		...
		// Instead of using treemap (for sorting the elements) we can use a hashmap and
		// use two
		// variables min and max where, min is the least value of hd and max is the max
		// value of hd.
	...
	public static void bottomviewOfBinarytree(Node node) {
		...
		// A TreeMap must be provided by either Comparator interface externally or must
		// have a type
		// that implements comparable interface. Here since Integer class implements
	...
	public boolean checkIfTreesIdentical(Node root1, Node root2) {
		...
		if (root1 != null && root2 != null) {
			...
			return (root1.data == root2.data && checkIfTreesIdentical(root1.left, root2.left)
	...
	public boolean checkIfHeightBalanced(Node root) {
		...
		if (Math.abs(leftHeight - rightHeight) <= 1 && checkIfHeightBalanced(root.left)
	...
	public static void main(String[] args) {
		...
		/*
		 * tree.addNode(tree.root, 2); tree.addNode(tree.root, 3);
		 * tree.addNode(tree.root, 4); tree.addNode(tree.root, 5);
		 * tree.addNode(tree.root, 6); tree.addNode(tree.root, 7);
		 */
		// tree.addNode(tree.root, 8);

		/*
		 * System.out.println("Maximum height of tree is : " +
		 * treeMaxHeight(tree.root));
		 * 
		 * System.out.println("\n-------------Pre order traversal-------------");
		...
		/*
		 * tree.addNode(tree.root, 5); tree.addNode(tree.root, 2);
		 * tree.addNode(tree.root, 3); tree.addNode(tree.root, 1);
		 * tree.addNode(tree.root, 6); tree.addNode(tree.root, 7);
		 * tree.addNode(tree.root, 8);
		 */

		/*
		 * tree.root = new Node(12); tree.root.left = new Node(10); tree.root.right =
		 * new Node(30); tree.root.right.left = new Node(25); tree.root.right.right =
		 * new Node(40);
		 * 
		 * 
		 * 
