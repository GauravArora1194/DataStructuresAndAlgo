...
public class BinaryTreeAncestor {
	...
	public static void main(String[] args) {
		...
		System.out.println("Dist(4, 5) = " + tree.findDistance(tree.root, 4, 5));

		System.out.println("Dist(4, 6) = " + tree.findDistance(tree.root, 4, 6));

		System.out.println("Dist(3, 4) = " + tree.findDistance(tree.root, 3, 4));

		System.out.println("Dist(2, 4) = " + tree.findDistance(tree.root, 2, 4));

		System.out.println("Dist(8, 5) = " + tree.findDistance(tree.root, 8, 5));
